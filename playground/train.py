    ...
    for episode in range(num_episodes):
        ...
        for _ in range(ppo_epochs):
            ...
            for start_idx in range(0, len(states), batch_size):
                ...
                choices = (
                    env.story.get_current_choices()
                )  # Assuming choices remain same

                new_action_logits, new_values = agent(
                    text_embeddings, attributes, choices
                )
                ...
                surr2 = (
                    torch.clamp(ratios, 1 - clip_epsilon, 1 + clip_epsilon)
                    * batch_advantages
                )
