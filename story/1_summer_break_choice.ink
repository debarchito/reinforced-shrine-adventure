...
@Kaori: You all remember that abandoned amusement park by the ocean in Ukiyo, right? Well, there’s a huge beach on the northern side.
...
- @Kaori: Just listen! That's your only job!

@Kaori: Back in the day, it was a major tourist attraction. The shrine’s mikos used to perform the legendary "Kagura Yume" dance, and people would come from all over just to see it at least once in their lives.
